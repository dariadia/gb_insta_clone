...
class SocketServer implements MessageComponentInterface
{
    ...
    private function sendHelloMessage(ConnectionInterface $conn)
    {
        ...
        $this->sendMessage($conn, ['message' => 'Всем привет', 'username' => 'это чат программы GeekGram']);
    }
    ...
    public function onClose(ConnectionInterface $conn)
    {
        ...
        echo "Подключение {$conn->resourceId} отключили \n";
    }

    public function onError(ConnectionInterface $conn, \Exception $e)
    {
        echo "Случилась такая ошибка {$e->getMessage()}\n";
        $conn->close();
    }
}
